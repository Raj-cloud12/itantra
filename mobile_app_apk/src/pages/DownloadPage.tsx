    ...
    <div className="min-h-screen w-full bg-[#030712] text-slate-100 font-sans selection:bg-cyan-500 selection:text-black flex flex-col relative overflow-y-auto overflow-x-hidden">
      ...
      <main className="relative z-10 flex-1 max-w-6xl mx-auto px-6 py-12 flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-2xl mb-16 text-left">
          <div className="w-full bg-gradient-to-b from-slate-900/90 to-slate-950/90 border border-slate-800 rounded-3xl p-8 sm:p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden backdrop-blur-xl">
            <div className="absolute top-0 right-0 w-56 h-56 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none"></div>
